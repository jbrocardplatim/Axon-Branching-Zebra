...
factor=5; //Fraction of the image width occupied by the axonal shaft = 1/5; see function get_profiles
...
//Width in units, a multiple of factor
sWidth=sWidth*pixelWidth/2;
sWidth=factor*floor(sWidth/factor);
//print(sWidth+ " " + unit);
...
function get_profiles(r){
	//Remove central axonal shaft ~ 1/factor original shaft
	setForegroundColor(0,0,0);
	temp=(1-1/factor)/2;
	makeRectangle(temp*sWidth,0,sWidth/factor, sHeight);
	run("Fill", "stack");
